...
#   - In future, you can persist totals to MySQL (see TODO).
#
# UI:
...
RTSP_URL = "rtsp://admin:KBSit%402468@192.168.5.61:554/ISAPI/Streaming/channels/101"
...
# NEW: Session total counters (accumulate since server start)
...
# TODO (future): record totals to MySQL periodically or on demand.
# For example:
#
# def record_totals_to_mysql(total_helmet: int, total_no_helmet: int):
#     # INSERT INTO helmet_stats (camera, ts, total_helmet, total_no_helmet) VALUES (...)
#     pass
...
def toggle_detection():
    ...
    if not new_state:
        # When turning OFF, clear timers & per-frame status,
        # but DO NOT reset session totals.
        last_pass_ts = None
        last_fail_ts = None
        ...
        # total_helmet_count / total_no_helmet_count stay as-is
...
def generate_frames():
    ...
    while True:
        ...
        # decide counts to send to UI (smoothed)
        if detection_ran:
